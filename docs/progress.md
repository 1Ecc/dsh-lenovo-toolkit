...
| 能力域 | 本地源码 **7 个**（电池、设备、性能、存储、应用、Wi-Fi、受控操作），共注册 17 个 DSH 工具 |
...
| Cordis 工具注册 | ⏳ **部分** | `87ee6c5` 是在 DSH Desktop 上撞到 schema 编译器才修的，说明电池版本被真实加载过；**17 工具版本未重新验证** |
...
| 商品 ID `1045747` | ❌ 待核对 | 需求方给的链接显示文本 `1045746` 与 href `1045747` 不一致，当前用 href 值 |
